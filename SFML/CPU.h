...
private:
	...
	static const int TIMA = 0xFF05; // zegar zwiekszany przez rejestr TAC
	static const int TMA = 0xFF06; // £adowany do TIMA gdy TIMA przeladowany
	static const int TAC = 0xFF07; // zawiera dane co ile TIMA powinien byc zwiekszany
	bool IME = false;
